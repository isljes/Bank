...
import com.example.bank.services.CurrencyRateService;
import com.example.bank.services.TransactionHistoryService;
import com.example.bank.services.UserService;
import com.example.bank.services.UserServiceImpl;
...
public class MainController {
    ...
    public String getWelcomePage(@CookieValue(value = "selectedCurrencyRates", required = false) String selectedCurrencyRatesFromCookie,
        ...
        List<CardEntity> cardEntities = userService.findByEmail(currentUser).getCardEntities();
    ...
    @PostMapping("/update")
    @PreAuthorize("authentication.authenticated")
    public String updateCook(@ModelAttribute("selectedCurrenciesDTO") SelectedCurrenciesDTO selectedCurrenciesDTO,
